...
func (c *serviceClient) Call(ctx context.Context, in *Request, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
func (UnimplementedServiceServer) Call(context.Context, *Request) (*emptypb.Empty, error) {
